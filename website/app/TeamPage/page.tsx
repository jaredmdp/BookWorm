...
const testimonials = [
  ...
  },
  {
    ...
    content:
      "I have honed my skills in designing user-friendly interfaces using Android Studio, creating seamless user experiences. I am also proficient in managing data storage and writing effective tests to ensure software reliability, while employing Git and Agile methodologies for efficient collaboration and project management.",
    avatar:
