...
public class BookPersistenceStub implements IBookPersistence {
    ...
    public BookPersistenceStub() {
        ...
        books.add(new Book("Harry Potter and the Philosopher’s Stone","J.K. Rowling", 6, Genre.Fiction, "9780747532743.",
        ...
        books.add(new Book("Operating Systems: Three Easy Pieces", "Remzi H. Arpaci-Dusseau", 19, Genre.NonFiction, "9780100650884",
