...
public class BookPersistenceStubTest {
    ...
    @Test public void testGetAllBooks() {
        ...
        //Fantasy
        dummyBooks.add(new Book("The Way of Kings", "Brandon Sanderson", 0, Genre.Fantasy, "9780765326355",
        ...
        dummyBooks.add(new Book("Mistborn", "Brandon Sanderson", 0, Genre.Fantasy, "9780765350381",
        ...
        dummyBooks.add(new Book("Words of Radiance", "Brandon Sanderson", 0, Genre.Fantasy, "9780765326362",
        ...
        dummyBooks.add(new Book("Elantris", "Brandon Sanderson", 0, Genre.Fantasy, "9780765311788",
        ...
        dummyBooks.add(new Book("The Alloy of Law", "Brandon Sanderson", 0, Genre.Fantasy, "9780765368546",
        ...
        //Adult
        dummyBooks.add(new Book("The Last Wish", "Andrzej Sapkowski", 2, Genre.Adult, "0575077832",
        ...
        dummyBooks.add(new Book("Blood of Elves", "Andrzej Sapkowski", 2, Genre.Adult, "9780316029193",
        ...
        dummyBooks.add(new Book("Sword of Destiny", "Andrzej Sapkowski", 2, Genre.Adult, "970575077832",
        ...
        dummyBooks.add(new Book("The Time of Contempt", "Andrzej Sapkowski", 2, Genre.Adult, "0316219134",
                "The New York Times bestselling series that inspired the international hit video game: The Witcher\n" +
        ...
        //Fiction
        dummyBooks.add(new Book("1984", "George Orwell", 3, Genre.Fiction, "9780452284234",
        ...
        dummyBooks.add(new Book("To Kill a Mockingbird", "Harper Lee", 4, Genre.Fiction, "92345678909",
        ...
        dummyBooks.add(new Book("The Great Gatsby", "F. Scott Fitzgerald", 5, Genre.Fiction, "9780743273565",
                "The Great Gatsby, F. Scott Fitzgerald's third book, stands as the supreme achievement of his career. This exemplary novel of the Jazz Age has been acclaimed by generations of readers. The story of the fabulously wealthy Jay Gatsby and his love for the beautiful Daisy Buchanan, of lavish parties on Long Island at a time when The New York Times noted \"gin was the national drink and sex the national obsession,\" it is an exquisitely crafted tale of America in the 1920s.\n" +
                        "\n" +
                        "The Great Gatsby is one of the great classics of twentieth-century literature."
        ));

        dummyBooks.add(new Book("Animal Farm", "George Orwell", 3, Genre.Fiction, "9780451526342",
        ...
        dummyBooks.add(new Book("Harry Potter and the Philosopher’s Stone","J.K. Rowling", 6, Genre.Fiction, "9780747532743.",
                "Harry Potter thinks he is an ordinary boy - until he is rescued by an owl, taken to Hogwarts School of Witchcraft and Wizardry, learns to play Quidditch and does battle in a deadly duel. The Reason ... HARRY POTTER IS A WIZARD!"
        ));

        dummyBooks.add(new Book("The Catcher in the Rye", "J.D. Salinger", 7, Genre.Fiction,"9780316769174",
        ...
        //Survival
        dummyBooks.add(new Book("The Wager", "David Grann", 8, Genre.Survival, "292345768801",
        ...
        dummyBooks.add(new Book("Life of Pi", "Yann Martel", 9, Genre.Survival, "292344468801",
                "Life of Pi is a fantasy adventure novel by Yann Martel published in 2001. The protagonist, Piscine Molitor \"Pi\" Patel, a Tamil boy from Pondicherry, explores issues of spirituality and practicality from an early age. He survives 227 days after a shipwreck while stranded on a boat in the Pacific Ocean with a Bengal tiger named Richard Parker.\n"
        ));

        dummyBooks.add(new Book("The Martian", "Andy Weir", 10, Genre.Survival, "292344464801",
        ...
        dummyBooks.add(new Book("Lord of the Flies", "William Golding", 11, Genre.Survival, "292346664801",
        ...
        dummyBooks.add(new Book("The Maze Runner", "James Dasher", 12, Genre.Survival, "292346964801",
        ...
        dummyBooks.add(new Book("On the Island", "Tracy Gravis Graves", 13, Genre.Survival, "29234555801",
        ...
        //NonFiction
        dummyBooks.add(new Book("Clean Code", "Robert C. Martin", 14, Genre.NonFiction, "9780132350884",
        ...
        dummyBooks.add(new Book("Atomic Habits", "James Clear", 15, Genre.NonFiction, "5780100220888",
        ...
        dummyBooks.add(new Book("The Art of War", "Sun Tzu", 16, Genre.NonFiction, "578099920888",
                "Twenty-Five Hundred years ago, Sun Tzu wrote this classic book of military strategy based on Chinese warfare and military thought. Since that time, all levels of military have used the teaching on Sun Tzu to warfare and civilization have adapted these teachings for use in politics, business and everyday life. The Art of War is a book which should be used to gain advantage of opponents in the boardroom and battlefield alike."
        ));

        dummyBooks.add(new Book("Introduction to Algorithms", "Thomas H. Cormen", 17, Genre.NonFiction, "9780132350884",
        ...
        dummyBooks.add(new Book("The C Programming Language", "Brian W. Kernighan", 18, Genre.NonFiction, "9780132650884",
        ...
        dummyBooks.add(new Book("Operating Systems: Three Easy Pieces", "Remzi H. Arpaci-Dusseau", 19, Genre.NonFiction, "9780100650884",
    ...
    public void testAddBook() {
        ...
        Book newBook = new Book("Oathbringer", "Brandon Sanderson", 0, Genre.Fantasy, "9783453270381");
    ...
    public void testAddDuplicateTitleBook() {
        ...
        Book dupeBook = new Book("The Way of Kings", "Brandon Sanderson", 0, Genre.Fantasy, "123"); //book with dupe title only
    ...
    public void testAddDuplicateISBNBook(){
        ...
        //check for duplicate book that is already in the system
        Book dupeBook = new Book("I am a Book", "Brandon Sanderson", 0, Genre.Fantasy, "9780765326355"); //book with dupe ISBN only
        Book result = bookStub.addBook(dupeBook);
        assertNull(result);
